...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_wrapper(
     ...
     KC_NO, KC_NO, __________________ALPHA_L4_________________, KC_NO, KC_NO, __________________ALPHA_R4_________________, KC_NO, KC_NO
  ),
  ...
  [_NAV] = LAYOUT_wrapper(
     ...
     KC_NO, KC_NO, ___________________NAV_L4__________________, KC_NO, KC_NO, ___________________NAV_R4__________________, KC_NO, KC_NO
  ),
  [_NUMBER] = LAYOUT_wrapper(
     ...
     KC_NO, KC_NO, _________________NUMBER_L4_________________, KC_NO, KC_NO, _________________NUMBER_R4_________________, KC_NO, KC_NO
  ),
  [_SYMBOL] = LAYOUT_wrapper(
     ...
     KC_NO, KC_NO, _________________SYMBOL_L4_________________, KC_NO, KC_NO, _________________SYMBOL_R4_________________, KC_NO, KC_NO
  ),
  [_ADJUST] = LAYOUT_wrapper(
     ...
     KC_NO, KC_NO, _________________ADJUST_L4_________________, KC_NO, KC_NO, _________________ADJUST_R4_________________, KC_NO, KC_NO
  )
};
